...
if __name__ == '__main__':
    output_dir = r'/users/jhzhe/Cloned_Repos/MPhys_Project/output_data/ned_search'
    url = "https://ned.ipac.caltech.edu/tap/sync"
    try:
        alert_csv = pd.read_csv(r'/users/jhzhe/Cloned_Repos/MPhys_Project/output_data/alerts/alert_data.csv')
